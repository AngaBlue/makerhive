import { returnLoan, AdminLoan } from "../../store/api/Loan";
...
import styles from "./AdminLoanCard.module.less";
...
export function AdminLoanCard(props: AdminLoan & { remove(id: number): any }) {
